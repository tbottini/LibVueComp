    ...
    <nav :style="nav">
        <div v-if="activePanel" id="panel" :style="panel" ref="panel">
            ...
            <ul>
                ...
                >
                   <p :style="'color: ' + direction.color || 'black'" :class="'dir ' + 'dir-' + $mq">{{ direction.name.toUpperCase() }}</p>
                </li>
            </ul>
            <Link instagram="https://www.instagram.com/atelier.azurees/"
            facebook="https://www.facebook.com/atelier.azurees/" mail="mailto:contact@atelier-azurees.com?subject=Contact Atelier Azurees" />
        </div>
    </nav>
</template>
<script>
